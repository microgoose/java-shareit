...
@RestControllerAdvice(basePackages = "ru.practicum.shareit.features.item.controller")
@Slf4j
public class ItemErrorHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> handleNotFoundException(ItemNotFound ex) {
        return new ResponseEntity<>(
